...
//  double int_part;
    ...
    RadarStation rls(55.930506, 37.522374, 0, 0);
...
//    << asin(r[1] / sqrt((1 - pow(r[0], 2)))) * 180 / M_PI << std::endl;
    ...
    RadarStation point1(55.930506, 37.522374, 0, 0);
    //RadarStation point2(55.930506, 37.522374, 500, 0);
    GeoPoint point2(55.930188, 37.518115, 500);
    std::cout << astroutils::RadToDeg(point1.AngleTo(point2));
