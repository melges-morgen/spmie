...
*
*  inputs        :
*    satn        - satellite number (Номер спутника)
*    epoch       - epoch time in days from jan 0, 1950. 0 hr (эпоха в днях)
*    bstar       - sgp4 type drag coefficient B*  (Коэфицент торможения) kg/m2er
*    ecco        - eccentricity (Эксентриситет)
*    argpo       - argument of perigee (output if ds) ( аргумент перицентра
*    inclo       - inclination (Угол отклонения от экватора)
*    mo          - mean anomaly (output if ds) (средняя аномалия)
*    no          - mean motion (среднее движение)
*    nodeo       - right ascension of ascending node (долгота восходящего угла)
*
*  outputs       :
